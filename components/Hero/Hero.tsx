        ...
        <div className="grid place-items-center h-full">
          <div className="lg:grid lg:gap-8">
            <div className="text-left lg:w-[64rem] md:max-w-5xl md:mx-auto">
              ...
              <p className="mt-3 font-sans text-base text-gray-300 sm:mt-5 sm:text-sm lg:text-sm xl:text-md max-w-md">
                I&apos;m currently working on personal projects to push my
                skills to the next level. Check out my portfolio below to see
                what I&apos;m working on.
              </p>
            </div>
          </div>
